				...
				<div class="col-sm-10">
					<table class="table table-sm">
	                    <tr ng-repeat="schreiber in schreibers">
	                        <td>[[ schreiber.prename]] [[ schreiber.name]] <span ng-if="(schreiber.type) == 0" ><i class="fas fa-pen"></i></span><span ng-if="(schreiber.type) > 0"><i class="fas fa-asterisk"></i></span></td>
	                        <td>
