<form class="form-horizontal" action="{eval var=$formURL}" method="POST">
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" id="prename" name="prename" value="{$person[0].prename}">
        </div>
    </div>
    <div class="form-group">
        <label for="name" class="col-sm-4 control-label">Name</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" id="name" name="name" value="{$person[0].name}">
        </div>
    </div>
    <div class="form-group">
        <label for="address" class="col-sm-4 control-label">Adresse</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" id="address" name="address" value="{$person[0].address}">
        </div>
    </div>
    <div class="form-group">
        <label for="plz" class="col-sm-4 control-label">PLZ</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" id="plz" name="plz" value="{$person[0].plz}">
        </div>
    </div>
    <div class="form-group">
        <label for="ort" class="col-sm-4 control-label">Ort</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" id="ort" name="ort" value="{$person[0].ort}">
        </div>
    </div>
    <div class="form-group">
        <label for="phone" class="col-sm-4 control-label">Telefon</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" id="phone" name="phone" value="{$person[0].phone}">
        </div>
    </div>
    <div class="form-group">
        <label for="mobile" class="col-sm-4 control-label">Mobile</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" id="mobile" name="mobile" value="{$person[0].mobile}">
        </div>
    </div>
    <div class="form-group">
        <label for="email" class="col-sm-4 control-label">E-Mail</label>
        <div class="col-sm-8">
            <input type="email" class="form-control" id="email" name="email" value="{$person[0].email}">
        </div>
    </div>
    <div class="form-group">
        <label for="email_parent" class="col-sm-4 control-label">E-Mail Eltern / gesetzlicher Vormund</label>
        <div class="col-sm-8">
            <input type="email" class="form-control" id="email_parent" name="email_parent" value="{$person[0].email_parent}">
        </div>
    </div>
    <div class="form-group">
        <label for="refid" class="col-sm-4 control-label">Schiedsrichter ID (wenn vorhanden)</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" id="refid" name="refid" value="{$person[0].refid}">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea class="form-control" id="licence_commment" name="licence_comment" rows="4">{$person[0].licence_comment}</textarea>
        </div>
    </div>
    <div class="form-group">
