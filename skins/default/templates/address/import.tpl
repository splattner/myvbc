<div class="card">
	<h4 class="card-header">
		...
		Von ClubDesk importieren
	</h4>
	<div class="card-body">
		<form enctype="multipart/form-data" action="index.php?page={$currentPage}&action=import" method="POST">
		{if $importStage == "new"}
		<div class="container">
			<div class="form-group row">
				<label for="extid" class="col-sm-3 col-form-label">ClubDesk CSV Export</label>

				<div class="col-sm-9">
					<input name="csv" type="file" size="50" accept="text/csv"> 
				</div>
			</div>

			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-8">
					<button type="submit" class="btn btn-dark" name="doImport" >importieren</button>
				</div>
			</div>
		</div>
		{/if}
